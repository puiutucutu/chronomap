...
function () {
   ...
   */
  function Chronomap(map, timelineHtmlRef) {
    var timelineOptions = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    _classCallCheck(this, Chronomap);
  ...
  _createClass(Chronomap, [{
    ...
    key: "onMapMarkerClick",
    value: function onMapMarkerClick(callback) {
    ...
    key: "onTimelineItemClick",
    value: function onTimelineItemClick(callback) {
      if (typeof callback !== "function") {
        throw new Error("Callback must be a function");
      } else {
    ...
    key: "panMapToMarkerMatchingTimelineItem",
    value: function panMapToMarkerMatchingTimelineItem() {
      var _this = this;
      ...
      this.timeline.on("doubleClick", function (props) {
        ...
        var timelineItem = {
          id: props.item,
          group: props.group
        }; // `item` from props is actually the `id` of the clicked upon item
        ...
        try {
          for (var _iterator = _this.leafletMarkerLayers.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var _step$value = _slicedToArray(_step.value, 2),
                layerName = _step$value[0],
                layerGroup = _step$value[1];
            ...
            try {
              for (var _iterator2 = markers[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                if (marker.options.id === timelineItem.id && // matching on both the id and the group/layer name
                layerName === timelineItem.group) {
                  _this.flyToMarkerAndOpenPopup(marker);
        ...
        _this.onClickCallbacks.timelineItem(props); // bubble event to subscriber
    ...
    key: "panTimelineToItemMatchingMapMarker",
    value: function panTimelineToItemMatchingMapMarker(overlayLayer) {
      var _this2 = this;

      overlayLayer.on("click", function (event) {
        // using event delegation
        var markerId = event.layer.options.id;

        _this2.panToTimelineItemIfExists(markerId); // bubble event to subscriber


        _this2.onClickCallbacks.leafletMarker(event);
      });
    }
    /**
     * @public
    ...
    key: "panToTimelineItemIfExists",
    value: function panToTimelineItemIfExists(itemId) {
      if (this.timelineItems.getIds().includes(itemId)) {
        this.timeline.setSelection(itemId, {
          focus: true
        });
      } else {
        console.warn("A timeline item with id of `".concat(itemId, "` does not exist"));
      }
    }
    /**
     * @public
    ...
    key: "panToTimelineItem",
    value: function panToTimelineItem(itemId) {
      this.timeline.setSelection(itemId, {
        focus: true
      });
    }
    ...
    key: "panMapAndTimelineByItemId",
    value: function panMapAndTimelineByItemId(id) {
      var searchDetails = {
        leaflet: {
          isFound: false
        },
      ...
      this.leafletMarkerLayers.forEach(function (layer, name) {
        var _iteratorNormalCompletion3 = true;
        var _didIteratorError3 = false;
        var _iteratorError3 = undefined;

        try {
          for (var _iterator3 = layer.getLayers()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var marker = _step3.value;

            if (marker.options.id === id) {
              searchDetails.leaflet = {
                marker: marker,
                isFound: true
              };
              break;
      ...
      if (searchDetails.leaflet.isFound && searchDetails.timeline.isFound) {
        ...
        throw new Error("A Timeline item matching supplied unique id ".concat(id, " could not be found"));
      } else if (searchDetails.leaflet.isFound === false) {
        throw new Error("A map marker matching supplied unique id ".concat(id, " could not be found"));
      } else {
        throw new Error("Neither a map marker nor a Timeline item matching supplied unique id ".concat(id, " could not be found"));
      }
    }
    /**
     * @public
    ...
    key: "populate",
    value: function populate(dataset, groupName, createMarkerProperties, createTimelineItem, markerPopupRenderer) {
      if (!Array.isArray(dataset)) {
        throw new Error("The `dataset` must be a 1-d array of objects.");
      }

      this.addMarkerLayerGroup(groupName);
      this.addTimelineLayer(groupName); // add data
      ...
      try {
        for (var _iterator4 = dataset.values()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var datasetItem = _step4.value;
          var targetLayer = this.leafletMarkerLayers.get(groupName);
          this.addMarker(datasetItem, targetLayer, createMarkerProperties(datasetItem), markerPopupRenderer);
          this.addTimelineItem(createTimelineItem(datasetItem));
        }
      } catch (err) {
    ...
    key: "populateSingle",
    value: function populateSingle(datasetItem, groupName, createMarkerProperties, createTimelineItem, markerPopupRenderer) {
    ...
    key: "populateWithCustomMarker",
    value: function populateWithCustomMarker(dataset, groupName, createMarker, createTimelineItem) {
      if (!Array.isArray(dataset)) {
        throw new Error("The `dataset` must be a 1-d array of objects.");
      }
      ...
      try {
        for (var _iterator5 = dataset.values()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var datasetValue = _step5.value;
          this.populateWithCustomMarkerSingle(datasetValue, groupName, createMarker, createTimelineItem);
        }
      } catch (err) {
    ...
    key: "populateWithCustomMarkerSingle",
    value: function populateWithCustomMarkerSingle(data, groupName, createMarker, createTimelineItem) {
      if (!this.leafletMarkerLayers.has(groupName)) {
        this.addMarkerLayerGroup(groupName);
      }
    ...
    key: "addMarkerLayerGroup",
    value: function addMarkerLayerGroup(name) {
    ...
    value: function addTimelineLayer(name) {
      if (!!this.timelineGroups.get(name)) {
        throw new Error("Timeline layer group `".concat(name, "` already exists"));
      } else {
    ...
    key: "addMarker",
    value: function addMarker(data, targetLayer, markerProperties, markerPopupRenderer) {
      var _this3 = this;

      var id = markerProperties.id,
          lng = markerProperties.longitude,
          lat = markerProperties.latitude;
      var marker = new L.marker([lat, lng], {
        id: id
      }).on("click", function (e) {
        _this3.onClickCallbacks.leafletMarker && _this3.onClickCallbacks.leafletMarker(e);
      });
    ...
    key: "addTimelineItem",
    value: function addTimelineItem(item) {
    ...
    key: "setBehaviour",
    value: function setBehaviour(groupName) {
      var markerLayerGroup = this.leafletMarkerLayers.get(groupName);
    ...
    value: function fitMap() {
      ...
      try {
        for (var _iterator6 = this.leafletMarkerLayers.values()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
          var layer = _step6.value;
          markers.push.apply(markers, _toConsumableArray(layer.getLayers()));
        }
      } catch (err) {
      ...
      var featureGroup = new L.featureGroup(markers);
      var bounds = featureGroup.getBounds().pad(0.05); // pad prevents viewport from cutting off markers on the edges
    ...
    key: "syncTimelineGroupsVisibilityWithLeafletControlOverlay",
    value: function syncTimelineGroupsVisibilityWithLeafletControlOverlay() {
      var _this4 = this;

      var checkboxes = this.retrieveCheckboxesForLeafletControlLayerOverlays();
      checkboxes.forEach(function (checkbox, overlayName) {
        checkbox.addEventListener("change", function (event) {
          _this4.handleVisibilityOfTimelineGroups(overlayName, event.target.checked);
        });
      });
    }
    /**
    ...
    key: "handleVisibilityOfTimelineGroups",
    value: function handleVisibilityOfTimelineGroups(overlayName, isChecked) {
      var _this5 = this;
      ...
      this.timelineGroups.forEach(function (group) {
        if (group.id === overlayName) {
          _this5.timelineGroups.update({
            id: group.id,
            visible: isChecked
          });
    ...
    key: "retrieveCheckboxesForLeafletControlLayerOverlays",
    value: function retrieveCheckboxesForLeafletControlLayerOverlays() {
      var checkboxes = new Map();
      var overlayHtmlElements = this.leafletControlLayer._overlaysList.children;
      var _iteratorNormalCompletion7 = true;
      var _didIteratorError7 = false;
      var _iteratorError7 = undefined;

      try {
        for (var _iterator7 = overlayHtmlElements[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          var el = _step7.value;

          if (el.control.type === "checkbox" && el.control.labels.length === 1) {
            var span = el.control.nextSibling;
            var checkboxName = span.textContent.trim();
    ...
    key: "flyToMarkerAndOpenPopup",
    value: function flyToMarkerAndOpenPopup(marker) {
    ...
    key: "flyToMarker",
    value: function flyToMarker(marker) {
    ...
    key: "openMarkerPopup",
    value: function openMarkerPopup(marker) {
      marker.openPopup();
    }
    /**
     * @public
    ...
    key: "scrollTimelineToBottom",
    value: function scrollTimelineToBottom() {
      var timelineVerticalScroll = this.timeline.dom.leftContainer;
    ...
    key: "clearMapAndTimeline",
    value: function clearMapAndTimeline() {
      this.clearMap();
      this.clearTimeline();
    }
    /**
    ...
    value: function clearMap() {
      ...
      this.leafletMarkerLayers.forEach(function (layer, layerName) {
        layer.clearLayers(); // clear Leaflet Markers

        _this6.leafletControlLayer.removeLayer(layer); // remove `L.LayerGroup` from Leaflet Control


        _this6.map.removeLayer(layer); // remove `L.LayerGroup` from Leaflet Map


        _this6.leafletMarkerLayers.delete(layerName); // delete `L.LayerGroup` instance from internal Map()
    ...
    key: "doesMapMarkerExist",
    value: function doesMapMarkerExist(id) {
      var _iteratorNormalCompletion8 = true;
      var _didIteratorError8 = false;
      var _iteratorError8 = undefined;

      try {
        for (var _iterator8 = this.leafletMarkerLayers.values()[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          var markerLayer = _step8.value;
          var _iteratorNormalCompletion9 = true;
          var _didIteratorError9 = false;
          var _iteratorError9 = undefined;

          try {
            for (var _iterator9 = markerLayer.getLayers()[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
    ...
    key: "doesTimelineItemExist",
    value: function doesTimelineItemExist(id) {
    ...
    key: "getMarkerLayer",
    value: function getMarkerLayer(id) {
      var _iteratorNormalCompletion10 = true;
      var _didIteratorError10 = false;
      var _iteratorError10 = undefined;

      try {
        for (var _iterator10 = this.leafletMarkerLayers.values()[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
          var markerLayer = _step10.value;
          var _iteratorNormalCompletion11 = true;
          var _didIteratorError11 = false;
          var _iteratorError11 = undefined;

          try {
            for (var _iterator11 = markerLayer.getLayers()[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      ...
      throw new Error("Could not find marker with id: ".concat(id));
    }
    /**
     * @public
     * @param {string} id
    ...
    value: function removeItemById(id) {
      if (!this.doesMapMarkerExist(id) && !this.doesTimelineItemExist(id)) {
        throw new Error("Cannot remove item with id ".concat(id, " because it has not been added"));
      }
    ...
    value: function removeGroup(group) {
      if (!this.timelineGroups.get(group) && !this.leafletMarkerLayers.has(group)) {
        throw new Error("`".concat(group, "` group does not exist"));
      }
    ...
    key: "removeMapMarkerById",
    value: function removeMapMarkerById(id) {
      var _this$getMarkerLayer = this.getMarkerLayer(id),
          _this$getMarkerLayer2 = _slicedToArray(_this$getMarkerLayer, 2),
          marker = _this$getMarkerLayer2[0],
          markerLayer = _this$getMarkerLayer2[1];
    ...
    key: "removeTimelineItemById",
    value: function removeTimelineItemById(id) {
...
exports.Chronomap = Chronomap;
//# sourceMappingURL=chronomap.cjs.js.map
