(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("vis-timeline"))
    : typeof define === "function" && define.amd
    ? define(["exports", "vis-timeline"], factory)
    : ((global = global || self),
      factory((global.chronoMap = {}), global.visTimeline));
})(this, function(exports, visTimeline) {
  "use strict";
      ...
      _createClass(Chronomap, [
        ...
        },
        {
          ...
          value: function panMapToMarkerMatchingTimelineItem() {
            ...
            this.timeline.on("doubleClick", function(props) {
              ...
              try {
                for (
                  var _iterator = _this.leafletMarkerLayers
                      .entries()
                      [Symbol.iterator](),
                    _step;
                  ...
                  try {
                    for (
                      var _iterator2 = markers[Symbol.iterator](), _step2;
        ...
        },
        {
          ...
          value: function panToTimelineItemIfExists(itemId) {
            if (this.timelineItems.getIds().includes(itemId)) {
              ...
              console.warn(
                "A timeline item with id of `".concat(
                  itemId,
                  "` does not exist"
                )
              );
        ...
        },
        {
          ...
          value: function panMapAndTimelineByItemId(id) {
            ...
            this.leafletMarkerLayers.forEach(function(layer, name) {
              ...
              try {
                for (
                  var _iterator3 = layer.getLayers()[Symbol.iterator](), _step3;
            ...
            if (
              searchDetails.leaflet.isFound &&
              searchDetails.timeline.isFound
            ) {
              ...
              throw new Error(
                "A Timeline item matching supplied unique id ".concat(
                  id,
                  " could not be found"
                )
              );
              ...
              throw new Error(
                "A map marker matching supplied unique id ".concat(
                  id,
                  " could not be found"
                )
              );
              ...
              throw new Error(
                "Neither a map marker nor a Timeline item matching supplied unique id ".concat(
                  id,
                  " could not be found"
                )
              );
        ...
        },
        {
          ...
          value: function populate(
            ...
            try {
              for (
                var _iterator4 = dataset.values()[Symbol.iterator](), _step4;
        ...
        },
        {
          ...
          value: function populateWithCustomMarker(
            dataset,
            groupName,
            createMarker,
            createTimelineItem
            ...
            try {
              for (
                var _iterator5 = dataset.values()[Symbol.iterator](), _step5;
        ...
        },
        {
          ...
          value: function populateWithCustomMarkerSingle(
            data,
            groupName,
            createMarker,
            createTimelineItem
        ...
        },
        {
          ...
          value: function addTimelineLayer(name) {
            if (!!this.timelineGroups.get(name)) {
              throw new Error(
                "Timeline layer group `".concat(name, "` already exists")
              );
            } else {
        ...
        },
        {
          ...
          value: function addMarker(
            ...
            var marker = new L.marker([lat, lng], {
              ...
              _this3.onClickCallbacks.leafletMarker &&
                _this3.onClickCallbacks.leafletMarker(e);
            });
        ...
        },
        {
          ...
          value: function fitMap() {
            ...
            try {
              for (
                var _iterator6 = this.leafletMarkerLayers
                    .values()
                    [Symbol.iterator](),
                  _step6;
                ...
                markers.push.apply(
                  markers,
                  _toConsumableArray(layer.getLayers())
                );
              }
            } catch (err) {
          ...
          value: function syncTimelineGroupsVisibilityWithLeafletControlOverlay() {
            ...
            checkboxes.forEach(function(checkbox, overlayName) {
              checkbox.addEventListener("change", function(event) {
                _this4.handleVisibilityOfTimelineGroups(
                  overlayName,
        ...
        },
        {
          ...
          value: function handleVisibilityOfTimelineGroups(
            overlayName,
            isChecked
          ) {
            var _this5 = this;
        ...
        },
        {
          ...
          value: function retrieveCheckboxesForLeafletControlLayerOverlays() {
            ...
            var overlayHtmlElements = this.leafletControlLayer._overlaysList
              .children;
            ...
            try {
              for (
                var _iterator7 = overlayHtmlElements[Symbol.iterator](), _step7;
                ...
                if (
                  el.control.type === "checkbox" &&
                  el.control.labels.length === 1
                ) {
        ...
        },
        {
          ...
          value: function scrollTimelineToBottom() {
            ...
            timelineVerticalScroll.scrollTop =
              timelineVerticalScroll.scrollHeight;
          }
          /**
           * @public
           */
        ...
        },
        {
          ...
          value: function doesMapMarkerExist(id) {
            ...
            try {
              for (
                var _iterator8 = this.leafletMarkerLayers
                    .values()
                    [Symbol.iterator](),
                  _step8;
                ...
                try {
                  for (
                    var _iterator9 = markerLayer.getLayers()[Symbol.iterator](),
                      _step9;
        ...
        },
        {
          ...
          value: function getMarkerLayer(id) {
            ...
            try {
              for (
                var _iterator10 = this.leafletMarkerLayers
                    .values()
                    [Symbol.iterator](),
                  _step10;
        ...
        },
        {
          ...
          value: function removeItemById(id) {
            if (
              !this.doesMapMarkerExist(id) &&
              !this.doesTimelineItemExist(id)
            ) {
              throw new Error(
                "Cannot remove item with id ".concat(
                  id,
...
//# sourceMappingURL=chronomap.umd.js.map
